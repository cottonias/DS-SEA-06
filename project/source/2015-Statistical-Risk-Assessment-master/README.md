This data was taken from the following GitHub repo for use in the General Assembly Data Science modeling project.
https://github.com/EarlyWarningProject/2015-Statistical-Risk-Assessment
